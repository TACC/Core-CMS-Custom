              ...
              <div key={index}>
                ...
                <FormGroup>
                  ...
                  >
                    ...
                    <option value="regular">
                      Regularly Scheduled Submission
                    </option>
                ...
                <Row>
                  <Col md={4}>
                    <FormGroup>
                      <Label
                        htmlFor={`extensions.${index}.applicableDataPeriod`}
                      >
                  ...
                  <Col md={4}>
                    ...
                    >
                      <Label
                        htmlFor={`extensions.${index}.requestedTargetDate`}
                      >
                  ...
                  <Col md={4}>
                    ...
                    >
                      <Label
                        htmlFor={`extensions.${index}.currentExpectedDate`}
                      >
