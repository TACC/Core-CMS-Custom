...
class SubmittersWithChildren(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "notes": obj.get("notes"),
            "users": [SubmitterUsersWithChildren.from_dict(_item) for _item in obj.get("users")] if obj.get("users") is not None else None
        })
        return _obj
