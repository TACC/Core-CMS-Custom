...
class FileInboxCreate(BaseModel):
    """
    FileInboxCreate
    """ # noqa: E501
    ...
    transaction_type: Annotated[str, Field(strict=True, max_length=1)]
    submitter_code: Annotated[str, Field(min_length=3, strict=True, max_length=8)]
    payor_code: StrictInt
    data_period_start: StrictInt
    data_period_end: StrictInt
    routed_to: Annotated[str, Field(strict=True, max_length=100)]
    comment: Annotated[str, Field(strict=True, max_length=8000)]
    file_pv: StrictBool
    file_mc: StrictBool
    file_pc: StrictBool
    file_dc: StrictBool
