...
class Registration(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["applicable_period_start", "applicable_period_end", "org_type", "business_name", "mail_address", "city", "state", "zip", "file_me", "file_pv", "file_mc", "file_pc", "file_dc", "submission_method", "submitting_for_self", "registration_id", "posted_date", "registration_status", "created_at", "updated_at"]
