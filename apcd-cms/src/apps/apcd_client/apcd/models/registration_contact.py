...
class RegistrationContact(BaseModel):
    ...
    RegistrationContact
    """ # noqa: E501
    notify_flag: Optional[StrictBool] = None
    ...
    registration_contact_id: StrictInt
    registration_id: StrictInt
    __properties: ClassVar[List[str]] = ["notify_flag", "contact_type", "contact_name", "contact_phone", "contact_email", "registration_contact_id", "registration_id"]
