...
class RegistrationContactCreate(BaseModel):
    """
    RegistrationContactCreate
    """ # noqa: E501
    notify_flag: StrictBool
    contact_type: StrictStr
    contact_name: StrictStr
    contact_phone: StrictStr
    contact_email: StrictStr
    __properties: ClassVar[List[str]] = ["notify_flag", "contact_type", "contact_name", "contact_phone", "contact_email"]
