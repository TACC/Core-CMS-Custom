...
class SubmissionLogUpdate(BaseModel):
    ...
    validation_suite: Optional[Annotated[str, Field(strict=True, max_length=50)]] = None
    ...
    __properties: ClassVar[List[str]] = ["submission_id", "file_type", "validation_suite", "outcome", "data_row_count", "stage_two_upload", "json_path", "html_path"]
