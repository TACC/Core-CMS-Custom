...
class PaginatedResponseSubmissionLog(BaseModel):
    """
    ...
    items: List[SubmissionLog] = Field(description="List of items returned in the response matching criteria")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "items": [SubmissionLog.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
