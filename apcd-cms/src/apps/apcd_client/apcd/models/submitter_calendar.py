...
class SubmitterCalendar(BaseModel):
    """
    SubmitterCalendar
    """ # noqa: E501
    data_period_start: Annotated[str, Field(min_length=6, strict=True, max_length=6)]
    data_period_end: Annotated[str, Field(min_length=6, strict=True, max_length=6)]
    ...
    file_pc: StrictBool
    file_dc: StrictBool
    granted_reprieve: StrictBool
    cancelled: StrictBool
    calendar_item_id: StrictInt
    created_at: Optional[datetime] = None
    updated_at: Optional[datetime] = None
    submitter_id: StrictInt
    __properties: ClassVar[List[str]] = ["data_period_start", "data_period_end", "expected_submission_date", "submission_id", "file_me", "file_pv", "file_mc", "file_pc", "file_dc", "granted_reprieve", "cancelled", "calendar_item_id", "created_at", "updated_at", "submitter_id"]
