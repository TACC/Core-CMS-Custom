...
class SubmissionWithChildren(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["apcd_id", "submitter_id", "zip_file_name", "received_timestamp", "data_period_start", "data_period_end", "test_submission_flag", "status", "outcome", "outcome_reason", "compressed_size", "processed_timestamp", "notes", "payor_code", "received_id", "submission_id", "created_at", "updated_at"]
