...
function InteractiveNavModal({ children }) {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    /* @__PURE__ */ jsx(Fab, { onClick: handleOpen, sx: {
      position: "fixed",
      bottom: 50,
      right: 50,
      height: 70,
      ...
      backgroundColor: "#FFF",
      padding: 0
    }, children: /* @__PURE__ */ jsx("img", { src: "https://cfde-drc.s3.us-east-2.amazonaws.com/assets/img/cfde_unified_icon.svg", alt: "nav-but", width: 120, height: 120 }) }),
    /* @__PURE__ */ jsx(
      Modal,
      {
        open,
...
// src/interactive.tsx
import { Container, Button, Typography, Tooltip, Link, Box as Box2 } from "@mui/material";
...
function InteractiveNavComponent() {
  return /* @__PURE__ */ jsxs2(Container, { sx: { position: "relative", width: 200 }, children: [
    dccs.map((dcc, i) => {
      ...
      return /* @__PURE__ */ jsx2(Tooltip, { title: /* @__PURE__ */ jsx2(Typography, { children: dcc.description }), children: /* @__PURE__ */ jsx2(
        Button,
        {
          variant: "contained",
          sx: {
          ...
          children: /* @__PURE__ */ jsx2(Link, { href: dcc.homepage, target: "_blank", rel: "noopener noreferrer", children: /* @__PURE__ */ jsx2(
            Box2,
            {
              sx: {
                position: "relative",
              ...
              children: /* @__PURE__ */ jsx2("img", { src: dcc.icon || "", alt: dcc.short_label || "", style: {
                top: 0,
                left: 0,
                position: "absolute",
                maxWidth: "100%",
    ...
    centers.map((center, i) => {
      return /* @__PURE__ */ jsx2(Button, { sx: __spreadValues({
        position: "absolute",
        width: { md: 190, xs: 150 },
        height: { md: 190, xs: 150 }
      }, center.position || {}), children: /* @__PURE__ */ jsx2(Container, { sx: {
        position: "relative",
        width: { md: 170, xs: 125 },
        height: { md: 170, xs: 125 }
      }, children: /* @__PURE__ */ jsxs2("a", { href: center.endpoint, children: [
        /* @__PURE__ */ jsx2("img", { src: `https://cfde-drc.s3.us-east-2.amazonaws.com/assets/img/${center.label}.png`, alt: center.label, loading: "lazy", decoding: "async", sizes: "100vw", style: {
          position: "absolute",
          height: "100%",
          width: "100%",
          maxWidth: "100%",
        ...
        /* @__PURE__ */ jsx2(Typography, { sx: __spreadValues({ color: "#FFF", position: "absolute", textTransform: "uppercase", fontSize: { md: 16, xs: 11.5 } }, center.text_position || {}), children: /* @__PURE__ */ jsx2("b", { children: center.label }) }),
        /* @__PURE__ */ jsx2(Container, { sx: { display: { md: "block", xs: "none" } }, children: /* @__PURE__ */ jsx2("img", { src: `https://cfde-drc.s3.us-east-2.amazonaws.com/assets/img/${center.label} 1.png`, alt: center.label, style: __spreadValues({ position: "absolute", width: 40, height: 40, zIndex: 100 }, center.image_position || {}) }) }),
        /* @__PURE__ */ jsx2(Container, { sx: { display: { md: "none", xs: "block" } }, children: /* @__PURE__ */ jsx2("img", { src: `https://cfde-drc.s3.us-east-2.amazonaws.com/assets/img/${center.label} 1.png`, alt: center.label, style: __spreadValues({ position: "absolute", zIndex: 100, width: 30, height: 30 }, center.image_position_small || {}) }) })
      ] }) }) }, center.label);
    }),
    /* @__PURE__ */ jsx2(
      Button,
      {
        ...
        children: /* @__PURE__ */ jsx2(Link, { href: "https://info.cfde.cloud", children: /* @__PURE__ */ jsx2(
          Box2,
          {
            sx: {
              position: "relative",
            ...
            children: /* @__PURE__ */ jsx2("img", { src: "https://cfde-drc.s3.us-east-2.amazonaws.com/assets/img/CFDE_logo.png", alt: "CFDE_Logo", style: {
              top: 0,
              left: 0,
              position: "absolute",
              maxWidth: "100%",
...
var CFDEWheel = () => {
  return /* @__PURE__ */ jsx3(InteractiveNavModal, { children: /* @__PURE__ */ jsx3(InteractiveNavComponent, {}) });
};
